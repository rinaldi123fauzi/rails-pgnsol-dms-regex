class ViewAllIndexInDocuments
  ...
  def fetch_documents
    documents = Document.left_outer_joins(:document_type, :sub_document_type, :document_reference, :sub2_document_type).select('*').order("documents.document_code ASC")
